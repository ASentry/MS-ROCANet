...
class CrossFormer(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=[3, 5, 7, 9], in_chans=3, num_classes=1000,
                 embed_dim=96, depths=[4], num_heads=[16],
                 group_size=7, crs_interval=[4], mlp_ratio=4., qkv_bias=True, qk_scale=None,
    ...
    def forward(self, x):
        ...
        for i, layer in enumerate(self.layers):
            feat, x = layer(x, H // 2 // (2 ** i), W // 2 // (2 ** i))
            # outs.append(feat)
